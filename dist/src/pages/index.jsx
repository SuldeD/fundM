...
const Home = () => {
    ...
    const openInto = [
        {
            ...
            money: "2,249,378.75 ₮",
            detail: "Богино хугацааны эх үүсвэртээ өгөөж хүртэн, санхүүгийн эрэлт хэрэгцээгээ хангах боломжтой.",
            image: "/images/write-lg.svg",
        },
        {
            title: "ЗЭЭЛ АВАХ",
            money: "272,532,055.00 ₮",
            detail: "Зээлийн эрхийн хэмжээгээ нэг удаа тогтоолгон богино хугацааны санхүүгийн хэрэгцээгээ хурдан шуурхай, шимтгэл бага байдлаар хангах боломжтой.",
            image: "/images/finance-lg.svg",
        },
        {
            title: "ЗАРАЛСАН ХҮҮ",
            money: "1.92 %",
            detail: "Тухайн өдрийн санхүүжилт өгөх болон зээл олгох заралсан хүү нь эрэлт хэрэгцээн дээр тулгуурлан тогтоодог.",
    ...
    if (data) {
          ...
          <div className="container mx-auto flex justify-between">
            <div className="w-full md:m-[50px]  lg:w-[50%]">
              ...
              <link_1.default href="/about-us">
                <button className="flex w-[169px] rounded-[9px] border-[2px] py-3 text-center text-[14px] font-bold leading-[14px] text-white hover:text-primary">
                  ...
                  {<icons_1.RightOutlined className="ms-2 mt-[1px] "/>}
                </button>
              </link_1.default>
            </div>
            ...
            <div className="hidden lg:flex">
              <div className="relative me-[14px] flex-row">
                ...
                <img src="/images/about-2.png" className="absolute right-0 mt-[11px] h-[185px] w-[185px]"/>
              </div>
        ...
        <div className="container mx-auto flex-wrap justify-center gap-[30px] py-[100px] lg:flex">
          {openInto.map((el, idx) => (<div key={idx} className="mb-[20px] h-[410px] w-full rounded-[30px] bg-[#fff] px-[60px] py-[30px] shadow-custom lg:max-w-[374px]">
        ...
        <div className="relative">
          ...
          <div className=" bg-black bg-[url('/images/fundNow-bg.png')] bg-cover bg-top bg-no-repeat py-[100px]">
            <div className="container mx-auto justify-between md:flex">
              ...
              <button onClick={() => router.push("/login")} className="mt-[20px] h-[44px] w-full rounded-[9px] bg-primary text-[14px] font-bold text-[#fff] hover:bg-sky-900 md:w-[220px]">
                ХАЙХ
              </button>
            </div>
          </div>
        ...
        <div className="py-[100px] pt-[60px]">
          ...
          <div className="mx-auto mt-[75px] justify-center gap-[30px] px-[30px] lg:flex ">
            {workerDiagram.map((el, idx) => (<div key={idx} className="relative mb-[20px] h-[300px] w-[100%] min-w-[180px] rounded-[30px] bg-[#fff] p-[32px] shadow-custom lg:max-w-[230px]">
                {workerDiagram.length - 1 != idx && (<div className="absolute right-[-62.5px] top-1/2 z-10 hidden lg:inline">
          ...
          <div className="container mx-auto py-[78px]">
            <div className="w-full p-[20px] lg:w-[430px]">
              ...
              <button className="me-1 h-[52px] w-[140px] rounded-[15px] bg-[#000] p-[10px]">
                <a className="flex" href="https://play.google.com/store/games" target="_blank">
              ...
              <button className="h-[52px] w-[140px] rounded-[15px] bg-[#000] p-[10px] ">
                <a className="flex" href="https://www.apple.com/app-store/" target="_blank">
