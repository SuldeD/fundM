        ...
        <Row justify="start" gutter={[0, 54]}>
          ...
          <Col span={24}>
            <div className={styles["loan-text"]}>
              Эрхэм харилцагч та зээлийн судалгаанд хамрагдаж, өөрийн санхүүгийн
              чадамжинд тохирох зээлийн эрхийг нэг жилийн хугацаатайгаар гэрээ
              байгуулж баталгаажуулснаар зээл авах боломжтой болно.
            </div>
          </Col>
          <Col span={24}>
            <div className={styles["loan-text"]}>Бүрдүүлэх материал:</div>
            <ul className={styles["loan-paragraph"]}>
